...
2. Run `./runtest --tls` to run Redis and Redis Cluster tests in TLS mode.

3. Run `./runtest --tls-module` to run Redis and Redis Cluster tests in TLS
   mode with Redis module.
