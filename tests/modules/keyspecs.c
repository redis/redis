...
int RedisModule_OnLoad(RedisModuleCtx *ctx, RedisModuleString **argv, int argc) {
    ...
    if (RedisModule_AddCommandKeySpecRange(ctx,"kspec.complex1","read",1,1,1) == REDISMODULE_ERR)
        return REDISMODULE_ERR;
    if (RedisModule_AddCommandKeySpecKeyword(ctx,"kspec.complex1","read","KEYS",1,1) == REDISMODULE_ERR)
        return REDISMODULE_ERR;
    ...
    if (RedisModule_CreateCommand(ctx,"kspec.complex2",kspec_complex2,"",0,0,0) == REDISMODULE_ERR)
        return REDISMODULE_ERR;
    if (RedisModule_AddCommandKeySpecKeyword(ctx,"kspec.complex2","read","KEYS",1,1) == REDISMODULE_ERR)
        return REDISMODULE_ERR;
    ...
    if (RedisModule_AddCommandKeySpecKeynum(ctx,"kspec.complex2","write",3,4,1) == REDISMODULE_ERR)
        return REDISMODULE_ERR;
    if (RedisModule_AddCommandKeySpecKeyword(ctx,"kspec.complex2","read","MOREKEYS",1,1) == REDISMODULE_ERR)
        return REDISMODULE_ERR;
