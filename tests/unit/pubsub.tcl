start_server {tags {"pubsub network"}} {
    ...
    test "Keyspace notifications: bitmap events test" {
        ...
        r bitop or mybitmap_copy mybitmap
        assert_equal "pmessage * __keyspace@${db}__:mybitmap_copy set" [$rd1 read]
        assert_equal "pmessage * __keyevent@${db}__:set mybitmap_copy" [$rd1 read]
