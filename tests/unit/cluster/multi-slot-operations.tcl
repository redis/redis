...
test "Continuous slots distribution" {
    assert_match "* 0-3276*" [r 0 CLUSTER NODES]
    assert_match "* 3277-6552*" [r 1 CLUSTER NODES]
    assert_match "* 6553-9828*" [r 2 CLUSTER NODES]
    assert_match "* 9829-13104*" [r 3 CLUSTER NODES]
    assert_match "* 13105-16383*" [r 4 CLUSTER NODES]
    assert_match "*0 3276*" [r 0 CLUSTER SLOTS]
    assert_match "*3277 6552*" [r 1 CLUSTER SLOTS]
    assert_match "*6553 9828*" [r 2 CLUSTER SLOTS]
    assert_match "*9829 13104*" [r 3 CLUSTER SLOTS]
    assert_match "*13105 16383*" [r 4 CLUSTER SLOTS]

    r 0 CLUSTER DELSLOTSRANGE 3001 3050
    assert_match "* 0-3000 3051-3276*" [r 0 CLUSTER NODES]
    assert_match "*0 3000*3051 3276*" [r 0 CLUSTER SLOTS]

    r 1 CLUSTER DELSLOTSRANGE 5001 5500
    assert_match "* 3277-5000 5501-6552*" [r 1 CLUSTER NODES]
    assert_match "*3277 5000*5501 6552*" [r 1 CLUSTER SLOTS]

    r 2 CLUSTER DELSLOTSRANGE 7001 7100 8001 8500
    assert_match "* 6553-7000 7101-8000 8501-9828*" [r 2 CLUSTER NODES]
    assert_match "*6553 7000*7101 8000*8501 9828*" [r 2 CLUSTER SLOTS]

    r 3 CLUSTER DELSLOTSRANGE 11001 12000 12101 12200
    assert_match "* 9829-11000 12001-12100 12201-13104*" [r 3 CLUSTER NODES]
    assert_match "*9829 11000*12001 12100*12201 13104*" [r 3 CLUSTER SLOTS]

    r 4 CLUSTER DELSLOTSRANGE 13501 14000 15001 16000
    assert_match "* 13105-13500 14001-15000 16001-16383*" [r 4 CLUSTER NODES]
    assert_match "*13105 13500*14001 15000*16001 16383*" [r 4 CLUSTER SLOTS]
}
