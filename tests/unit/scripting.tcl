...
if {$is_eval == 1} {
    ...
    proc run_script {args} {
        r function load LUA test replace [format "library.register_function('test', function(KEYS, ARGV)\n %s \nend)" [lindex $args 0]]
    ...
    proc run_script_on_connection {args} {
        ...
        $rd function load LUA test replace [format "library.register_function('test', function(KEYS, ARGV)\n %s \nend)" [lindex $args 1]]
...
start_server {tags {"scripting"}} {
    ...
    test {Timedout script does not cause a false dead client} {
        ...
        if {$is_eval == 1} {
            ...
            set buf "*6\r\n\$8\r\nfunction\r\n\$4\r\nload\r\n\$3\r\nlua\r\n\$4\r\ntest\r\n\$7\r\nreplace\r\n\$83\r\nlibrary.register_function('test', function() while 1 do redis.call('ping') end end)\r\n"
            append buf "*3\r\n\$5\r\nfcall\r\n\$4\r\ntest\r\n\$1\r\n0\r\n"
            append buf "*1\r\n\$4\r\nping\r\n"
        }
        $rd write $buf
