    ...
    foreach_redis_id id {
        if {$id < 5} {
            wait_for_condition 1000 50 {
                ...
                fail "Primary #$id does not have 2 slaves as expected"
            }
        }
    }
}

test "Killing all the slaves of primary #0 and #1" {
...
# Now test the migration to a primary which used to be a slave, after
# a failver.
...
test "Kill slave #7 of primary #2. Only slave left is #12 now" {
...
test "Instance 12 is now a primary without slaves" {
