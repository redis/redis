...
if 0 {
    ...
    r himport prepare fs_lp_raw f0 f1 [string repeat x 70]       ;# TMPL_LP + FIELDS_RAW (long field name)
    r himport set htmpl_lp_raw fs_lp_raw 0 1 2
    r himport prepare fs_arr_lp f0 f1 f2                         ;# TMPL_ARRAY + FIELDS_LP (long value)
