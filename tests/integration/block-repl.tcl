...
start_server {tags {"repl"}} {
    start_server {} {
        ...
        set load_handle0 [start_bg_block_op $primary_host $primary_port 9 100000 $::tls]
        set load_handle1 [start_bg_block_op $primary_host $primary_port 9 100000 $::tls]
        set load_handle2 [start_bg_block_op $primary_host $primary_port 9 100000 $::tls]
