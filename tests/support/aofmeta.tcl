set ::aof_meta_filename "appendonly.aof_manifest"
set ::aof_meta_temp_filename "temp_aof.manifest"
set ::default_aof_basename "appendonly.aof"
set ::base_aof_sufix "_b_"
set ::incr_aof_sufix "_i_"
...
proc get_cur_base_aof_name {dir} {
    set meta_path [get_full_path $dir $::aof_meta_filename]
...
proc assert_aof_meta_content {dir content} {
    set meta_path [get_full_path $dir $::aof_meta_filename]
    set fp [open $meta_path r+]
    set lines {}
    while {1} {
...
proc append_to_aofmeta {str} {
    upvar fp fp
    puts -nonewline $fp $str
}

proc create_aof_meta {aof_meta_path code} {
    upvar fp fp 
    set fp [open $aof_meta_path w+]
    uplevel 1 $code
    close $fp
}
