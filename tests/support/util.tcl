...
proc generate_fuzzy_traffic_on_key {key type duration} {
    ...
    set hll_commands {PFADD PFCOUNT PFMERGE PFDEBUG}
    set commands [dict create string $string_commands hash $hash_commands zset $zset_commands list $list_commands set $set_commands stream $stream_commands vectorset $vset_commands array $array_commands hll $hll_commands]
if 0 {
