...
PKG_COMPILE_COUNT="1"
PKG_VERSION="$REDIS_VERSION-$XREDIS_VERSION-$PKG_COMPILE_COUNT"
...
cp ${SRC_DIR}/{redis-server,redis-benchmark,redis-cli,redis-sentinel,redis-check-aof,redis-check-rdb,../redis-ctrip.conf} ${XREDIS_INSTALL_DIR}
