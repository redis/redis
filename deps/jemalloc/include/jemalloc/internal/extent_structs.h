...
#define EXTENT_BITS_DEFRAG_RETAIN_WIDTH  1
#define EXTENT_BITS_DEFRAG_RETAIN_SHIFT  (EXTENT_BITS_SLAB_WIDTH + EXTENT_BITS_SLAB_SHIFT)
#define EXTENT_BITS_DEFRAG_RETAIN_MASK  MASK(EXTENT_BITS_DEFRAG_RETAIN_WIDTH, EXTENT_BITS_DEFRAG_RETAIN_SHIFT)

#define EXTENT_BITS_COMMITTED_WIDTH  1
#define EXTENT_BITS_COMMITTED_SHIFT  (EXTENT_BITS_DEFRAG_RETAIN_WIDTH + EXTENT_BITS_DEFRAG_RETAIN_SHIFT)
