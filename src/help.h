...
struct commandHelp {
  ...
  char *since;
    ...
    "1.0.1" },
    { "MSETEX",
    "[m/s] key value expiryseconds_or_milliseconds [key value expiryseconds_or_milliseconds]",
    "Set multiple keys to multiple values with expiry set to seconds or millisconds. ",
    1,
    "6.0.0" },
    { "MSETNXEX",
    "[m/s] key value expiryseconds_or_milliseconds [key value expiryseconds_or_milliseconds]",
    "Set multiple keys to multiple values with expiry set to seconds or millisconds, if none of the key exists",
    1,
    "6.0.0" },
    { "MULTI",
    "",
