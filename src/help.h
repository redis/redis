...
struct commandHelp {
  ...
  char *since;
    ...
    "2.8.7" },
    { "BLMMOVE",
    "destination numkeys [srckey1 ...] LEFT|RIGHT LEFT|RIGHT timeout",
    "Pop an element from source list, push it to destination list and return it; or block until one is available",
    2,
    "6.2.0" },
    { "BLMOVE",
    ...
    "6.2.0" },
    { "LMMOVE",
    "destination numkeys [srckey1 ...] LEFT|RIGHT LEFT|RIGHT",
    "Pop an element from one of the source key, save it to destination list and then return it.",
    2,
    "6.2.0" },
    { "LOLWUT",
    "[VERSION version]",
