...
struct commandHelp {
  ...
  char *since;
    ...
    "1.0.5" },
    { "ZRANGESTORE",
    "destination (Z[REV]RANGE arguments|Z[REV]RANGEBYLEX arguments|Z[REV]RANGEBYSCORE arguments)",
    "Perform the requested range operation and store the resulting sorted set in a new key",
    4,
    "6.0.0" },
    { "ZRANK",
    "key member",
