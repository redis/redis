...
struct commandHelp {
  ...
  char *since;
    ...
    "5.0.0" },
    { "CLIENT KILL",
    "[ip:port] [ID client-id] [TYPE normal|primary|slave|pubsub] [USER username] [ADDR ip:port] [SKIPME yes/no]",
    ...
    { "CLUSTER REPLICAS",
    "node-id",
    "List replica nodes of the specified primary node",
    12,
    "5.0.0" },
    { "CLUSTER REPLICATE",
    "node-id",
    "Reconfigure a node as a replica of the specified primary node",
    12,
    "3.0.0" },
    { "CLUSTER RESET",
    "[HARD|SOFT]",
    ...
    { "REPLICAOF",
    "host port",
    "Make the server a replica of another instance, or promote it as primary.",
    9,
    "5.0.0" },
    { "RESTORE",
    ...
    { "SLAVEOF",
    "host port",
    "Make the server a replica of another instance, or promote it as primary. Deprecated starting with Redis 5. Use REPLICAOF instead.",
    9,
    "1.0.0" },
    { "SLOWLOG",
    "subcommand [argument]",
