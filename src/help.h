...
struct commandHelp {
  ...
  char *since;
    ...
    { "MIGRATE-ASYNC-FENCE",
    "-",
    "Wait for the current MIGRATE-ASYNC operation finished.",
    0,
    "4.2.0"},
    { "MIGRATE-ASYNC-STATUS",
    "-",
    "Show the progress of the current MIGRATE-ASYNC operation.",
    0,
    "4.2.0"},
    { "MIGRATE-ASYNC-CANCEL",
    "-",
    "Cancel the current MIGRATE-ASYNC operation.",
    0,
    "4.2.0"},
};
