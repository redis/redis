...
#define CLIENT_IN_MEMORY_PREFETCH (1ULL<<53) /* The client is in the prefetching batch to avoid nested prefetch. */
...
enum {
    ...
    PENDING_CMD_KEYRESULT_VALID = 1 << 2,     /* Command's keys_result is valid and cached */
};
