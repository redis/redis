...
/* The command is being executed as part of importing slots during a slot
 * migration (on the destination node or its replica). */
#define REDISMODULE_CTX_FLAGS_SLOT_MIGRATION_IMPORT (1<<27)
