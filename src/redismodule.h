...
typedef struct RedisModuleUserID RedisModuleUserID;
...
REDISMODULE_API RedisModuleUserID * (*RedisModule_GetCurrentUserID)(RedisModuleCtx *ctx) REDISMODULE_ATTR;
REDISMODULE_API void (*RedisModule_FreeUserID)(RedisModuleUserID *userid) REDISMODULE_ATTR;
REDISMODULE_API int (*RedisModule_ACLCheckCommandPermissions)(RedisModuleUserID *userid, RedisModuleString **argv, int argc) REDISMODULE_ATTR;
REDISMODULE_API int (*RedisModule_ACLCheckKeyPermissions)(RedisModuleUserID *userid, RedisModuleString *key) REDISMODULE_ATTR;
REDISMODULE_API int (*RedisModule_ACLCheckChannelPermissions)(RedisModuleUserID *userid, RedisModuleString *ch, int literal) REDISMODULE_ATTR;
REDISMODULE_API int (*RedisModule_ACLAddLogEntry)(RedisModuleCtx *ctx, RedisModuleUserID *userid, RedisModuleString *object) REDISMODULE_ATTR;
...
static int RedisModule_Init(RedisModuleCtx *ctx, const char *name, int ver, int apiver) {
    ...
    REDISMODULE_GET_API(GetCurrentUserID);
    REDISMODULE_GET_API(FreeUserID);
