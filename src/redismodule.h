...
REDISMODULE_API int (*RedisModule_AddPostExecutionUnitJob)(RedisModuleCtx *ctx, RedisModulePostExecUnitJobFunc callback, void *pd, void (*free_pd)(void*)) REDISMODULE_ATTR;
...
static int RedisModule_Init(RedisModuleCtx *ctx, const char *name, int ver, int apiver) {
    ...
    REDISMODULE_GET_API(AddPostExecutionUnitJob);
