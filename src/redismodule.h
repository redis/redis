...
REDISMODULE_API int (*RedisModule_ReplyWithBuffer)(RedisModuleCtx *ctx, RedisModuleCtx *buffer) REDISMODULE_ATTR;
...
REDISMODULE_API RedisModuleCtx * (*RedisModule_CreateReplyBuffer)(RedisModuleCtx *ctx) REDISMODULE_ATTR;
...
static int RedisModule_Init(RedisModuleCtx *ctx, const char *name, int ver, int apiver) {
    ...
    REDISMODULE_GET_API(ReplyWithBuffer);
    ...
    REDISMODULE_GET_API(CreateReplyBuffer);
