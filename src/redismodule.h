...
/* Next notify flag, this flag should no be used directly by the user.
 * Instead, Users should use RedisModule_GetKeyspaceNotificationFlagsAll.
 * When adding a new notification this value should be updated. */
