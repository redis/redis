...
REDISMODULE_API RedisModuleUserID * (*RedisModule_CreateModuleUserID)(RedisModuleCtx *ctx) REDISMODULE_ATTR;
REDISMODULE_API void (*RedisModule_FreeModuleUserID)(RedisModuleUserID *userid) REDISMODULE_ATTR;
...
static int RedisModule_Init(RedisModuleCtx *ctx, const char *name, int ver, int apiver) {
    ...
    REDISMODULE_GET_API(CreateModuleUserID);
    REDISMODULE_GET_API(FreeModuleUserID);
