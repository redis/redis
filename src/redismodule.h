...
#define REDISMODULE_XAPI_STABLE(X) \
    ...
    X(RedisModuleServerInfoData *, GetServerInfo, (RedisModuleCtx *ctx, const char *section)) \
    X(void, FreeServerInfo, (RedisModuleCtx *ctx, RedisModuleServerInfoData *data)) \
    X(RedisModuleString *, ServerInfoGetField, (RedisModuleCtx *ctx, RedisModuleServerInfoData *data, const char* field)) \
    X(const char *, ServerInfoGetFieldC, (RedisModuleServerInfoData *data, const char* field)) \
    X(long long, ServerInfoGetFieldSigned, (RedisModuleServerInfoData *data, const char* field, int *out_err)) \
    X(unsigned long long, ServerInfoGetFieldUnsigned)(RedisModuleServerInfoData *data, const char* field, int *out_err)) \
    X(double, ServerInfoGetFieldDouble, (RedisModuleServerInfoData *data, const char* field, int *out_err)) \
