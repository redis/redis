...
int REDISMODULE_API_FUNC(RedisModule_ListInRange)(RedisModuleKey *key, long index, unsigned char direction);
int REDISMODULE_API_FUNC(RedisModule_ListRangeNext)(RedisModuleKey *key);
void REDISMODULE_API_FUNC(RedisModule_ListRangeStop)(RedisModuleKey *key);
RedisModuleString *REDISMODULE_API_FUNC(RedisModule_ListRangeCurrentElement)(RedisModuleKey *key);
...
static int RedisModule_Init(RedisModuleCtx *ctx, const char *name, int ver, int apiver) {
    ...
    REDISMODULE_GET_API(ListInRange);
    REDISMODULE_GET_API(ListRangeNext);
    REDISMODULE_GET_API(ListRangeStop);
    REDISMODULE_GET_API(ListRangeCurrentElement);
