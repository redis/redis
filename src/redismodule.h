...
#define REDISMODULE_SUBEVENT_FORK_CHILD_BEFORE 0
#define REDISMODULE_SUBEVENT_FORK_CHILD_BORN 1
#define REDISMODULE_SUBEVENT_FORK_CHILD_DIED 2
#define _REDISMODULE_SUBEVENT_FORK_CHILD_NEXT 3
