...
/* PSYNC type argument table */
struct redisCommandArg PSYNC_type_Subargs[] = {
...
{"offset",ARG_TYPE_INTEGER,-1,NULL,NULL,NULL,CMD_ARG_NONE},
{"type",ARG_TYPE_ONEOF,-1,NULL,NULL,NULL,CMD_ARG_NONE,.subargs=PSYNC_type_Subargs},
{0}
};
...
/* SYNC type argument table */
struct redisCommandArg SYNC_type_Subargs[] = {
{"aof",ARG_TYPE_PURE_TOKEN,-1,"AOF",NULL,NULL,CMD_ARG_NONE},
{"rdb",ARG_TYPE_PURE_TOKEN,-1,"RDB",NULL,NULL,CMD_ARG_NONE},
{0}
};
...
/* SYNC argument table */
struct redisCommandArg SYNC_Args[] = {
{"type",ARG_TYPE_ONEOF,-1,NULL,NULL,NULL,CMD_ARG_NONE,.subargs=SYNC_type_Subargs},
{0}
};
...
{"psync","Internal command used for replication",NULL,"2.8.0",CMD_DOC_NONE,NULL,NULL,COMMAND_GROUP_SERVER,PSYNC_History,PSYNC_tips,syncCommand,-4,CMD_NO_ASYNC_LOADING|CMD_ADMIN|CMD_NO_MULTI|CMD_NOSCRIPT,0,.args=PSYNC_Args},
...
{"sync","Internal command used for replication",NULL,"1.0.0",CMD_DOC_NONE,NULL,NULL,COMMAND_GROUP_SERVER,SYNC_History,SYNC_tips,syncCommand,-1,CMD_NO_ASYNC_LOADING|CMD_ADMIN|CMD_NO_MULTI|CMD_NOSCRIPT,0,.args=SYNC_Args},
