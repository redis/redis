...
exercise string, string-backed bitmap, compact-hash, and stream commands through
the real command parser and executor, using a local socketpair-backed client.
